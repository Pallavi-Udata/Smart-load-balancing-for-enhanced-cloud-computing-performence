"""
Django settings for lbaproject project.
...
SECRET_KEY = 'django-insecure-7ze+p5@+p$kbx8n$8a)0vps3f$g*&apy@rgqlb593@t&8^$ut$'
...
WSGI_APPLICATION = 'lbaproject.wsgi.application'
